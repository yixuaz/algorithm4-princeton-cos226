package commonutil.intervalTree;//package commonutil.intervalTree;
//
///*
...
// */
//public class IntervalSTExp2<K extends Comparable<K>, V> implements Iterable<IntervalSTExp2.Node<K, V>>, IntervalSearchTree<K,V> {
//
//
//
//    /**
...
//
//    @Override
//    public Iterator<IntervalSTExp2.Node<K, V>> iterator() {
...
//    }
//
//    private class IntervalSTIterator implements Iterator<IntervalSTExp2.Node<K, V>> {
//
//        private int cntNodesVisited = 0;
//        private IntervalSTExp2.Node<K, V> lastVisitedNode = null;
//        private LinkedList<Node<K, V>> parentStack;
//        private int size;
//
//        public IntervalSTIterator() {
//            parentStack = new LinkedList<>();
//            size = IntervalSTExp2.this.size();
//        }
//
//        @Override
